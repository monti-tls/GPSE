            ...
            //// ExpressionNode ////
            {
                auto rule = [](lang::TreePass* pass, lang::Node*& node, ExpressionNode* expression)
                {
                    ...
                    else if(expression->isBinary())
                    {
                        ...
                        if(lhsNode->which() == LITERAL_NODE && rhsNode->which() == LITERAL_NODE)
                        {
                        ...
                        {
                            // don't work with lhsNode / rhsNode references to
                            // expression->children() elements
                            ...
                            if((zero && expression->binaryOperation() == ExpressionNode::Binary::Add) || (one && expression->binaryOperation() == ExpressionNode::Binary::Mul))
                            {
                        ...
                        else if(rhsNode->which() == LITERAL_NODE)
                        {
                            ...
                            if((expression->binaryOperation() == ExpressionNode::Binary::Add && zero) || (expression->binaryOperation() == ExpressionNode::Binary::Sub && zero) ||
                               (expression->binaryOperation() == ExpressionNode::Binary::Mul && one) || (expression->binaryOperation() == ExpressionNode::Binary::Div && one))
                            {
